...
def Home():
        ...
        window = tk.Tk()
        window.title("Covid-19 Prediction in X-Ray images using Deep Learning")
        ...
        message1 = tk.Label(window, text="Covid-19 Prediction in X-Ray images using Deep Learning" ,bg=bgcolor  ,fg=fgcolor  ,width=50  ,height=3,font=('times', 30, 'italic bold underline')) 
